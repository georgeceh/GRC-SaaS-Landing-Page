...
const supabaseClient = (typeof window !== 'undefined' && createClient && SUPABASE_URL && SUPABASE_ANON_KEY)
          ...
          default:
              return (
                  <form onSubmit={handleLogin} className="mt-8 space-y-6">
                      <div>
                          <label htmlFor="login-email" className="text-sm font-medium text-slate-500 mb-1 block">Email Address</label>
                          <Input
                              id="login-email"
                              type="email"
                      ...
                      <Button type="submit" className="w-full bg-slate-700 hover:bg-slate-600 text-slate-200" disabled={formState === 'loading' || !!emailError}>
                          {formState === 'loading' ? (
